...
create table if not exists categories (
  ...
  image_url text not null default '/images/smsm-logo.png',
...
create table if not exists order_items (
  ...
  image text not null default '/images/smsm-logo.png',
  size text not null,
...
begin
  ...
  loop
    ...
    values (
      ...
      product_row.name_ar,
      product_row.name_en,
      coalesce(product_row.images[1], '/images/smsm-logo.png'),
